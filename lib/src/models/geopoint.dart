...
class GeoPoint {
  ...
  GeoPoint.fromJson(final Map<String, dynamic> json)
  ...
  GeoPoint.fromLatLng({required final LatLng point, this.name})
  ...
  ///
  /// [withId] include the id of the geopoint or not
  Map<String, String> toStringsMap({final bool withId = true}) {
  ...
  LatLng? toLatLng({final bool ignoreErrors = false}) {
    LatLng? latLng;
    try {
  ...
  String _toGeoJsonFeatureString(final String type) {
